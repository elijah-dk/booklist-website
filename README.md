...
### User Support
The current database structure is built around a single shared dataset and doesn't support separate user accounts. Expanding it into a multi-user application would require restructuring the schema and adding authentication. this would be a final step.
...
### Code Structure
Some parts of the frontend rely on large multi-purpose functions and inefficient logic. Refactoring and breaking things into smaller modules is planned once the core features are finished.
